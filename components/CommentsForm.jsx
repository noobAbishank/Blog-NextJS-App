        ...
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div>
                    ...
                    <label className="ml-2 text-gray-500 cursor-pointer" htmlFor="storeData">Save my name and e-mail for the next time I comment.</label>
                </div>
            </div>
            ...
            <div className="mt-8">
                ...
                {showSuccessMessage && <span className="text-xl float-right font-semibold mt-3 ml-3 text-green-500">Comment submitted for review</span>}
            </div>
        </div>
    )
}
